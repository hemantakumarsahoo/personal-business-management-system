...
<div class="col-sm-12">  
 <center> <h3><font color="#00CC00">Completed & Delivered Client Project</font></h3></center>
 <?php
include "config.php";
$q=mysqli_query($con,"select * from client_project where status='completed'");
...
{
	echo '<form method="post" action="viewcompletedproject.php">';
	echo '<tr>';
