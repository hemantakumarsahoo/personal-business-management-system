...
<div class="col-sm-12">  
 <center> <h3><font color="#00CC00">New Client Project</font></h3></center>
 <?php
include "config.php";
$q=mysqli_query($con,"select * from client_project as t1 left join project_assigned as t2 on t1.pid=t2.projectid where t1.status='progress' and t2.developerid='".$_SESSION['empid']."'");
...
{
	echo '<form method="post" action="devviewnewproject.php">';
	echo '<tr>';
