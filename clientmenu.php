   ...
   <div class="navbar-header nav_2">
    ...
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            <li class="current_page"><a href="clienthome.php">Home</a></li>
            ...
            <li class="dropdown">
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu drop_menu" role="menu">
                <li><a href="addclientproject.php">Add</a></li>
                <li><a href="manageclientproject.php">Manage</a></li>
                </ul>
                </li> 
                
                <li><a href="clientpayment.php">Payment Details</a></li>
